...
export default function Menu() {
  return (
    <div className="mx-auto flex h-full w-full max-w-[min(100%,350px)] flex-col items-center bg-white p-[clamp(0.75rem,2vw,1rem)] text-center sm:mx-0 sm:max-w-none sm:w-full">
